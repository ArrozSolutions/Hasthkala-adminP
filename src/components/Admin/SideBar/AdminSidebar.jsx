...
import { BiGridAlt, BiListUl, BiGroup, BiCompass, BiCard, BiSolidInbox, BiUser, BiBullseye, BiLogOut, BiGift, BiMenu } from 'react-icons/bi'
...
const AdminSidebar = ({ name }) => {
    ...
    return (
        <div className={`relative  ${show?'w-0':'w-0 xl:w-[255px]'} bg-darkred border-r shadow-2xl `}>
            ...
            <div className={`${show ? 'hidden' : 'block'} relative w-[305px] transition-all ] duration-200`}>
                ...
                <aside id="sidebar-multi-level-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform  sm:translate-x-0" aria-label="Sidebar">
                    <div class="h-full py-4 w-full dark:bg-gray-800 border-r bg-white shadow-2xl">
                        <ul class="space-y-2 font-medium">
                            ...
                            <li className='relative pl-3'>
                                ...
                                <ul id="dropdown-example" class={`${dropdown ? 'block' : 'hidden'} py-2 space-y-2 text-[14px]`}>
                                    <Link to={'/admin-products'}><li>
                                        <p class={`flex items-center w-full pb-1 ${name == 'products' ? 'text-darkred' : 'text-gray-700'} transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700`}><span className='rotate-90 mr-2 text-[#1a1a1d80]'>|</span> Products</p>
                                    </li></Link>
                                    <Link to={'/admin-categories'}><li>
                                        <p class={`flex items-center w-full pb-1  ${name == 'categories' ? 'text-darkred' : 'text-gray-700'} transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700`}><span className='rotate-90 mr-2 text-[#1a1a1d80]'>|</span> Category</p>
                                    </li></Link>
                                    <Link to={'/admin-coupons'}><li>
                                        <p class={`flex items-center w-full  pb-1 ${name == 'coupons' ? 'text-darkred' : 'text-gray-700'} transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700`}><span className='rotate-90 mr-2 text-[#1a1a1d80]'>|</span> Coupons</p>
                                    </li></Link>
                                    <Link to={'/admin-attributes'}><li>
                                        <p class={`flex items-center w-full ${name == 'attributes' ? 'text-darkred' : 'text-gray-700'} transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700`}><span className='rotate-90 mr-2 text-[#1a1a1d80]'>|</span> Attributes</p>
                                    </li></Link>
                                </ul>
                            </li>
                            <Link to={'/admin-giftbox'}><li className='relative pl-3 flex '>
                                ...
                                <p class={`flex items-center p-2 ${name == 'giftbox' ? 'text-darkred' : 'text-gray-700'} rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group`}>
                                    <BiGift size={22} />
                                    <span class="flex-1 sm:ml-3 whitespace-nowrap ">Gift Box</span>
                                </p>
                            </li></Link>
                            <Link to={'/admin-giftcard'}><li className='relative pl-3 flex '>
                                ...
                                <p class={`flex items-center p-2 ${name == 'giftcard' ? 'text-darkred' : 'text-gray-700'} rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group`}>
                                    <BiCard size={22} />
                                    <span class="flex-1 sm:ml-3 whitespace-nowrap ">Gift Cards</span>
                                </p>
                            </li></Link>
