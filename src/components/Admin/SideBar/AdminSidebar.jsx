                        ...
                        <ul className="space-y-2 font-medium">
                            ...
                            <li className='relative pl-3'>
                                ...
                                <button onClick={handleDropDown} type="button" className="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                                    <p className={`flex items-center justify-between ${name == 'catalog' ? 'text-darkred' : 'text-gray-700'} rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${name === 'catalog' ? 'border-b-2' : ''}  border-darkred w-full pr-8`}>
                                        <div className='flex'>
                                            <BiListUl size={22} />
                            ...
                            <Link to={'/admin-settings'}><li className='relative pl-3 flex'>
                                ...
                                <p className={`flex items-center p-2 ${name == 'settings' ? 'text-darkred' : 'text-gray-700'} rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group`}>
