        ...
        <div className='flex flex-col w-full h-screen '>
          ...
          <div className='flex flex-col pt-5 pl-5 pr-10'>
            ...
            <div className='w-full border rounded-lg mt-5 h-20 items-center flex pl-4 pt-4 pb-4 justify-between pr-5'>
              ...
              <Link to={'/admin-add-giftcard'}><button className='text-white h-11 hover:scale-110 transition-all duration-300 w-[200px] rounded-md flex justify-center items-center text-sm font-dmsans  bg-darkred'>Add GiftCard<span className='ml-2'><BiPlus size={15} /></span></button></Link>
                      ...
                      giftcards?.map((card, key) => (
                        ...
                        <tr key={key} class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                          <th scope="row" class="uppercase px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <div className='h-12 w-12 rounded-full border'><img className='h-full w-full rounded-full' src={card?.images[0]?.img} alt="" /></div>
                          </th>
