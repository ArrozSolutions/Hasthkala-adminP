...
import { AdminAllCategory, AdminCreateProduct, createGiftBoxAction, createGiftCardAction } from '../../actions/Admin/AdminAction';
...
const AddGiftCard = () => {
    ...
    const handleAddGiftCard = (e) => {
        ...
        dispatch(createGiftCardAction(giftcard)).then(() => {
            navigate('/admin-giftcard')
        })
    }
                ...
                <div className='flex flex-col w-full h-screen'>
                    ...
                    <div className='w-full h-full pl-10 pt-5 pr-5'>
                        <div className='flex justify-between pr-10'>
                            <h1 className='font-dmsans text-lg'>Add GiftCard</h1>
                        </div>
                            <div>
                                <div className='mt-4'>
                                    ...
                                    <div className='pr-[500px] mb-20'>
                                        <div className='items-center justify-between flex mt-10 text-black font-dmsans'>
                                            ...
                                            <input onChange={(e) => { setName(e.target.value) }} type="text" placeholder='GiftCard name' className='rounded-lg  text-sm pl-3 bg-[#1a1a1d0d] border-[#1a1a1d15] h-12 w-[500px]' required />
                                        </div>
                                        ...
                                        <div className='items-center justify-between flex mt-10 text-black font-dmsans'>
                                            ...
                                            <input type="number" onChange={(e) => { setPrice(e.target.value) }} placeholder='GiftCard Price' className='rounded-lg  text-sm pl-3 bg-[#1a1a1d0d] border-[#1a1a1d15] h-12 w-[500px]' required />
                                        </div>
                                        <div className='items-center justify-between flex mt-10 text-black font-dmsans'>
                                            <p className='mr-10'>Quantity</p>
                                            <input onChange={(e) => { setQuantity(e.target.value) }} type="number" placeholder='GiftCard Quantity ' className='rounded-lg  text-sm pl-3 bg-[#1a1a1d0d] border-[#1a1a1d15] h-12 w-[500px]' required />
                                        </div>
                                        <div className='items-center justify-between flex mt-10 text-black font-dmsans'>
                                            <p className='mr-10'>Material</p>
                                            <input onChange={(e) => { setMaterial(e.target.value) }} type="text" placeholder='GiftCard Material' className='rounded-lg  text-sm pl-3 bg-[#1a1a1d0d] border-[#1a1a1d15] h-12 w-[500px]' />
                                        </div>
                                        <div className='items-center justify-between flex mt-10 text-black font-dmsans'>
                                        ...
                                        <div className='items-center justify-between flex mt-10 text-black font-dmsans'>
                                            ...
                                            <input onChange={(e) => { setTags(e.target.value) }} type="text" placeholder='GiftCard Tags' className='rounded-lg  text-sm pl-3 bg-[#1a1a1d0d] border-[#1a1a1d15] h-12 w-[500px]' />
                                        </div>
                                        <div className='items-center flex mt-10 text-black font-dmsans'>
                                            <button className='w-[100px] h-10 flex justify-center items-center border rounded-md shadow text-sm font-dmsans text-darkred' type='button' onClick={() => { navigate('/admin-giftcard') }}>Cancel</button>
                                            <button className='w-[100px] h-10 flex justify-center items-center border rounded-md shadow text-sm font-dmsans bg-darkred text-white ml-5' type='Submit' onClick={handleAddGiftCard}>Submit</button>
                                        </div>
