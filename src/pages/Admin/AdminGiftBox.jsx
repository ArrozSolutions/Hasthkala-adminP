        ...
        <div className='flex flex-col w-full h-screen '>
          ...
          <div className='flex flex-col pt-5 pl-5 pr-10'>
            ...
            <div className='w-full border rounded-lg mt-5 h-20 items-center flex pl-4 pt-4 pb-4 justify-end pr-5'>
              ...
              <Link to={'/admin-add-giftbox'}><button className='text-white h-11 hover:scale-110 transition-all duration-300 w-[200px] rounded-md flex justify-center items-center text-sm font-dmsans  bg-darkred'>Add GiftBox<span className='ml-2'><BiPlus size={15} /></span></button></Link>
