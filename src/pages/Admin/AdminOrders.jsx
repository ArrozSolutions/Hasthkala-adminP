        ...
        <div className='flex flex-col w-full h-screen '>
          ...
          <div className='flex flex-col pt-5 pl-5 pr-10'>
            ...
            <div className='w-full border rounded-lg mt-5 h-20 items-center flex pl-4 pt-4 pb-4 justify-between pr-5'>
              <input onChange={(e) => { handleSearch(e.target.value) }} type="text" placeholder='Search by Customer Name' className='font-dmsans rounded-md pl-3 h-12 border border-[#1a1a1d08] bg-[#1a1a1d12] text-sm w-[360px]' />
              <select onChange={(e) => { handleStatusChange(e.target.value) }} name="" className='rounded-md pl-3 h-12 border font-dmsans border-[#1a1a1d08] bg-[#1a1a1d12] text-sm w-[360px]' id="">
